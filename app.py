...
def generate_newsletter():
    ...
    prompt = """
    현재는 2026년 6월입니다. 당신은 실리콘밸리의 탑티어 테크 인사이더이자 냉철한 기술 분석가입니다. 
    지난 24~48시간 동안 글로벌 개발자 생태계(GitHub Trending, Hacker News, Product Hunt, Reddit)에서 가장 뜨겁게 논의되고 있는 최신 IT 기술 및 오픈소스 트렌드를 분석해 뉴스레터 형태로 작성해 주세요.
    ...
    [출력 양식]
    제목: 🚀 [Tech Pulse] 오늘 자 필수 테크 트렌드 & 구조적 분석 Report
    ---
    ### 짚고 넘어가야 할 최신 기술 3선
    ■ 1. [기술명] (요약, 활용처, 장점, 단점)
    ■ 2. [기술명]
